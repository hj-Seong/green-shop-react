...
const Home = () => {
    ...
    const [words, setWords] = useState([
        ...
        {text : "나는 신실하지 않으며, 심지어 이렇게 말하는 이 순간에도 그렇다.", author:"쥘 르나르"},
        {text : "선한 봉사의 씨앗을 뿌려라. 감사의 기억들이 이 씨앗을 자라게 할 것이다.", author:"마담 드 스탈"},
        {text : "과거를 기억 못하는 이들은 과거를 반복하기 마련이다.", author:"조지 산타야나"},
        {text : "무력은 모든 것을 정복하지만, 그 승리는 오래가지 못한다.", author:"에이브러햄 링컨"},
    ])
